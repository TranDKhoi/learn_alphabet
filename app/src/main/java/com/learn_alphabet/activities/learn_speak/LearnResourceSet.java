...
public class LearnResourceSet {
    ...
    public HashMap<String, List<List<Integer>>> dataMap = new HashMap<String, List<List<Integer>>>() {{
        put(ICON1, Arrays.asList(Arrays.asList(R.drawable.a, R.drawable.b, R.drawable.c, R.drawable.d, R.drawable.e, R.drawable.f, R.drawable.g, R.drawable.h, R.drawable.i, R.drawable.j, R.drawable.k, R.drawable.l, R.drawable.m, R.drawable.n, R.drawable.o, R.drawable.p, R.drawable.q, R.drawable.r, R.drawable.s, R.drawable.t, R.drawable.u, R.drawable.v, R.drawable.w, R.drawable.x, R.drawable.y, R.drawable.z, R.drawable.resta),
                Arrays.asList(R.raw.a, R.raw.b, R.raw.c, R.raw.d, R.raw.e, R.raw.f, R.raw.g, R.raw.h, R.raw.i, R.raw.j, R.raw.k, R.raw.l, R.raw.m, R.raw.n, R.raw.o, R.raw.p, R.raw.q, R.raw.r, R.raw.s, R.raw.t, R.raw.u, R.raw.v, R.raw.w, R.raw.x, R.raw.y, R.raw.z, R.raw.yahh_abc)));
        put(ICON2, Arrays.asList(Arrays.asList(R.drawable.n1, R.drawable.n2, R.drawable.n3, R.drawable.n4, R.drawable.n5, R.drawable.n6, R.drawable.n7, R.drawable.n8, R.drawable.n9, R.drawable.n10, R.drawable.resta),
        ...
        put(ICON6, Arrays.asList(Arrays.asList(R.drawable.an1, R.drawable.an2, R.drawable.an3, R.drawable.an4, R.drawable.an5, R.drawable.an6, R.drawable.an7, R.drawable.an8, R.drawable.an9, R.drawable.an10, R.drawable.an11, R.drawable.an12, R.drawable.an13, R.drawable.an14, R.drawable.an15, R.drawable.an16, R.drawable.resta),
                Arrays.asList(R.raw.an1, R.raw.an2, R.raw.an3, R.raw.an4, R.raw.an5, R.raw.an6, R.raw.an7, R.raw.an8, R.raw.an9, R.raw.an10, R.raw.an11, R.raw.an12, R.raw.an13, R.raw.an14, R.raw.an15, R.raw.an16, R.raw.yahh_abc)));
        put(ICON7, Arrays.asList(Arrays.asList(R.drawable.color_black, R.drawable.color_blue, R.drawable.color_brown, R.drawable.color_green, R.drawable.color_orange, R.drawable.color_pink, R.drawable.color_purple, R.drawable.color_red, R.drawable.color_yellow, R.drawable.resta),
                Arrays.asList(R.raw.color_black, R.raw.color_blue, R.raw.color_brown, R.raw.color_green, R.raw.color_orange, R.raw.color_pink, R.raw.color_purple, R.raw.color_red, R.raw.color_yellow, R.raw.yahh_abc)));
        put(ICON8, Arrays.asList(Arrays.asList(R.drawable.ears, R.drawable.eyes, R.drawable.foot, R.drawable.hand, R.drawable.head, R.drawable.mouth, R.drawable.nose, R.drawable.resta),
                Arrays.asList(R.raw.ears, R.raw.eyes, R.raw.foot, R.raw.hand, R.raw.head, R.raw.mouth, R.raw.nose, R.raw.yahh_abc)));
        put(ICON9, Arrays.asList(Arrays.asList(R.drawable.artist, R.drawable.dancer, R.drawable.doctor, R.drawable.firefighter, R.drawable.laborer, R.drawable.magician, R.drawable.nurse, R.drawable.pilot, R.drawable.plumber, R.drawable.police_officer, R.drawable.singer, R.drawable.soldier, R.drawable.student, R.drawable.teacher, R.drawable.veterinarian, R.drawable.resta),
                Arrays.asList(R.raw.artist, R.raw.dancer, R.raw.doctor, R.raw.firefighter, R.raw.laborer, R.raw.magician, R.raw.nurse, R.raw.pilot, R.raw.plumber, R.raw.police_officer, R.raw.singer, R.raw.soldier, R.raw.student, R.raw.teacher, R.raw.veterinarian, R.raw.yahh_abc)));
        put(ICON10, Arrays.asList(Arrays.asList(R.drawable.arrow, R.drawable.circle2, R.drawable.crescent, R.drawable.diamond, R.drawable.heart, R.drawable.oval, R.drawable.pentagon, R.drawable.rectangle2, R.drawable.square, R.drawable.star, R.drawable.triangle, R.drawable.resta),
                Arrays.asList(R.raw.arrow, R.raw.circle, R.raw.crescent, R.raw.diamond, R.raw.heart, R.raw.oval, R.raw.pentagon, R.raw.rectangle, R.raw.square, R.raw.star, R.raw.triangle, R.raw.yahh_abc)));
